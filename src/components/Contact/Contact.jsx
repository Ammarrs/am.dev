  ...
  return (
    <div className="center flex">
      <div className="section">
        ...
        <div className="subtitle contact-sub">
          Open to full-time roles and interesting conversations
        </div>
              ...
              <div className="form-group">
                <div className="form-section">
                  ...
                  <input
                    type="text"
                    className="form-input"
                    placeholder="role / opportunity / collab"
                  />
                </div>
              </div>
              <div className="form-group">
                <div className="form-section">
                  ...
                  <textarea
                    ...
                    placeholder="Hey, we're looking for a software engineer who..."
                  ></textarea>
                </div>
              </div>
              <div className="form-group">
